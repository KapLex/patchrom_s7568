...
.method final ensureActivitiesVisibleLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;Ljava/lang/String;I)V
    ...
    .line 1336
    .local v13, bMwModeCheck:Z
    const/16 v20, 0x0

    .line 1337
    .local v20, fullscreenMask:I
    const/16 v16, -0x1

    .line 1338
    .local v16, currentTaskId:I
    const/16 v22, 0x0

    .line 1341
    .local v22, isTopFullScreenActivity:Z
    :goto_1
    if-ltz v21, :cond_10
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/am/ActivityStack;->getActivityZone(Lcom/android/server/am/ActivityRecord;)I
    ...
    .line 1492
    .end local v17           #doThisProcess:Z
    .end local v19           #forceHiding:Z
    ...
    .line 1358
    .restart local v19       #forceHiding:Z
    :cond_14
    const/16 v22, 0x0
    ...
    const-string v4, "Exception thrown making hidden: "
    ...
    .line 1442
    .restart local v17       #doThisProcess:Z
    :cond_19
    if-nez v19, :cond_1a
    ...
    const-string v4, "Exception thrown making visibile: "
    ...
    .line 1536
    .local v24, multiWindowService:Lcom/android/server/sec/MultiWindowManagerService;
    new-instance v25, Ljava/util/ArrayList;

    invoke-direct/range {v25 .. v25}, Ljava/util/ArrayList;-><init>()V

    .line 1537
    .local v25, mwList:Ljava/util/List;,"Ljava/util/List<Lcom/android/server/sec/MwActivityRecord;>;"
    move-object/from16 v0, p0
    ...
    .line 1542
    .local v28, topRecord:Lcom/android/server/am/ActivityRecord;
    const/16 v23, 0x0
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/sec/MultiWindowManagerService;->isMultiWindow(Landroid/content/ComponentName;)Z
    ...
    .end local v27           #r:Lcom/android/server/am/ActivityRecord;
    :cond_1f
    invoke-virtual/range {v24 .. v25}, Lcom/android/server/sec/MultiWindowManagerService;->setActivityStackInfo(Ljava/util/List;)V

    .line 1555
    .end local v6           #bPreventSplit:Z
    .end local v23           #j:I
    .end local v24           #multiWindowService:Lcom/android/server/sec/MultiWindowManagerService;
    .end local v25           #mwList:Ljava/util/List;,"Ljava/util/List<Lcom/android/server/sec/MwActivityRecord;>;"
    .end local v28           #topRecord:Lcom/android/server/am/ActivityRecord;
...
.method final resumeTopActivityLocked(Lcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-direct {v0, v1}, Lcom/android/server/am/ActivityStack;->taskForIdLocked(Lcom/android/server/am/ActivityRecord;)Z
...
.method final startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;[Landroid/net/Uri;ILandroid/content/pm/ActivityInfo;Landroid/os/IBinder;Ljava/lang/String;IIIZZ[Lcom/android/server/am/ActivityRecord;)I
    ...
    .line 2637
    .local v40, rp:Landroid/app/enterprise/IRestrictionPolicy;
    if-eqz v40, :cond_3
    ...
    .end local v33           #len$:I
    .end local v40           #rp:Landroid/app/enterprise/IRestrictionPolicy;
    :cond_3
    :goto_2
    ...
    .restart local v40       #rp:Landroid/app/enterprise/IRestrictionPolicy;
    :cond_7
    ...
    .line 2677
    .local v39, pwdPolicy:Landroid/app/enterprise/IPasswordPolicy;
    if-eqz v39, :cond_3

    invoke-interface/range {v39 .. v39}, Landroid/app/enterprise/IPasswordPolicy;->isChangeRequested()I
    ...
    .line 2681
    .local v42, topActivity:Ljava/lang/String;
    const/16 v29, 0x0
    ...
    .end local v39           #pwdPolicy:Landroid/app/enterprise/IPasswordPolicy;
    .end local v42           #topActivity:Ljava/lang/String;
    :catch_2
    move-exception v24
    ...
    .line 2824
    .local v43, watchIntent:Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    .line 2830
    .end local v43           #watchIntent:Landroid/content/Intent;
    :goto_b
    if-eqz v19, :cond_1d
    ...
    .line 2824
    .restart local v43       #watchIntent:Landroid/content/Intent;
    :cond_1c
    const/16 v19, 0x0
